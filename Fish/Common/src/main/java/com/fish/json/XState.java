...
//    //////HANDLE "players" INPUT
//    JsonArray playerArray = stateAsJson.getAsJsonArray("players");
//    List<HexPlayer> players = getPlayersList(playerArray);
//
...
//  static List<HexPlayer> getPlayersList (JsonArray playerArray) {
//    List<HexPlayer> resultPlayerList = new ArrayList<>();
...
//      HexPlayer p = new HexPlayer(1, pc);
//      p.addToScore(score);
...
//  static JsonObject createPlayerObject(HexPlayer p, GameState gs) {
