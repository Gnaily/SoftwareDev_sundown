...
//    this.twoPlayerGame.getPlayerScore(PlayerColor.WHITE);//Returns "HexPlayer not found"
//  }
//
//  @Test
...
//
//    List<HexPlayer> players = new ArrayList<>(Arrays.asList(
//        new HexPlayer(10, PlayerColor.WHITE), new HexPlayer(12, PlayerColor.RED)));
//
