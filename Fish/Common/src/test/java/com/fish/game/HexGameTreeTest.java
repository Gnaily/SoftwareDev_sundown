...
//    List<HexPlayer> players1 = Arrays.asList(new HexPlayer(10, PlayerColor.BLACK), new HexPlayer(11, PlayerColor.BROWN),
//            new HexPlayer(43, PlayerColor.RED));
//
...
//    players1 = Arrays.asList(new HexPlayer(11, PlayerColor.BROWN),
//            new HexPlayer(43, PlayerColor.RED));
//
