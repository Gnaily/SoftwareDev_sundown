...
public class HexGameTreeTest {
  ...
  public void setUp() throws Exception {
    ...
    List<InternalPlayer> players1 = Arrays.asList(new HexPlayer(PlayerColor.BLACK), new HexPlayer(PlayerColor.BROWN),
    ...
    players1 = Arrays.asList(new HexPlayer(PlayerColor.BROWN),
            new HexPlayer(PlayerColor.RED));
  ...
  public void getNextGameTree() {
    ...
    assertEquals(Integer.valueOf(3), this.threePlayerTree.getState().getScoreBoard().get(PlayerColor.BLACK));
  ...
  public void getResultState() {
    ...
    assertEquals(Integer.valueOf(1), gs.getScoreBoard().get(PlayerColor.BROWN));
    assertTrue(coords.contains(new Coord(1, 2)));
    assertFalse(coords.contains(new Coord(0, 0)));
